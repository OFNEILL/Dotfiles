...
-- WASD Movement
keymap.set("n", "w", "k", { noremap = true })
keymap.set("n", "a", "h", { noremap = true })
keymap.set("n", "s", "j", { noremap = true })
keymap.set("n", "d", "l", { noremap = true })

-- Remove line and line contents
keymap.set("n", "D", "dd", { desc = "Delete line" })
